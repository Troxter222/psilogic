...
def fused_param_step(
    ...
    *,
    ...
    if chaos_gain > 0.0 and gamma_eff > 0:
        ...
        total_scalar_decay = (lr * wd + chaos_contrib * chaos_gain).reshape(1).to(torch.float32).contiguous()
        if qd_eff > 0:
            qd_contrib = (
...
def fused_group_step(
    ...
    *,
    ...
    if uniform_step and homogeneous:
        ...
        update_gradient_norm_ema_batched(
            gn_scaled_vec, step, fast_vec, slow_vec, gn_avg_vec, eps
        )
