...
echo "  Logs:      \${OUTPUT_DIR:-benchmark/results/local_full}/logs/"
echo "  Note:      default pipeline is a longer local recipe (5 seeds / 5000"
echo "             steps / fp16), not the paper results/full/ protocol."
echo ""
